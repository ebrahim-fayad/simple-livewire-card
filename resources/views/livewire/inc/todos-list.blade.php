<div wire:key='{{ $todo->id }}'
    ...
    <div class="flex justify-between  items-center space-x-2">
        <div class="flex gap-1 ">
            ...
            <div class="">
                <input wire:model='editingTodoNewName' type="text" placeholder="Todo.."
    ...
    <div class="mt-3 text-xs text-gray-700">
        ...
        <button wire:click='cancelEditing' class="mt-3 px-4 py-2 bg-red-500 text-white font-semibold rounded hover:bg-red-600">Cancel</button>
        @endif
